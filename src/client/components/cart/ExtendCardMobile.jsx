...
import { Button, ButtonGroup, Divider, FormControl, InputLabel, List, ListItem, MenuItem, Select, Typography } from '@mui/material';
// REDUX 
...
export default function ExtendCardMobile(props) {
  ...
  const MenuProps = {
    ...
    return (
        <List sx={{display: "flex", flexWrap: "wrap", width: "110%"}}>
          <ListItem sx={{display: "flex", flexWrap: "wrap", width: "100%"}}>
            <img
              width="50"
              height="50"
              src={item.img}
