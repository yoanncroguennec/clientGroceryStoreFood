...
export default function MyAccount() {
  ...
  const infosMyAccount = [
    {
      title: "Prénom",
      desc: `${user.details.username}`
    },
    {
      title: "Nom de Famille",
      desc: `${user.details.lastname}`
    },
    {
      title: "Email",
      desc: `${user.details.email}`
    },
    {
      title: "Numéro de téléphone",
      desc: `${user.details.phone}`
    },
    {
      title: "Addresse",
      desc: `${user.details.address}`
    },
    {
      title: "Code Postal",
      desc: `${user.details.postal_code}`
    },
    {
      title: "Ville",
      desc: `${user.details.city}`
    },
    {
      title: "Pays",
      desc: `${user.details.country}`
    }              
  ]

  const [img, setImg] = useState(user.details.sex)
