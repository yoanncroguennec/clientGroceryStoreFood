...
// COMPONENTS
import ExtendCardMobile from "../../components/cart/ExtendCardMobile";
// REDUX + FILES
...
export default function CartMobile({matches}) {
        ...
        <>
            <Navbar />
                ...
                <Box sx={{ marginBottom: 10, paddingTop: 15}}>
                    ...
                    <Container sx={{border: "3px solid black", borderRadius: 10,backgroundImage: "url(/assets/imgs/cart/bgCart.jpg)", backgroundSize: "cover", width: "95%", boxShadow: "rgba(0, 0, 0, 0.25) 0px 25px 50px -12px;", opacity: "0.9", marginBottom: "250px"}}>
                        <Container sx={{}}>
                            <Typography align='center' variant='h4' sx={{color: "white"}}>MON PANIER</Typography>
                        </Container>
                        
                        <Container sx={{backgroundColor: "#fff", borderRadius: 5, color: "#000", opacity: "0.7", width: "95%"}}>

                            {items.map(item => {
                            return(
                                <>
                                    <ExtendCardMobile item={item}/>
                                </>
                            )
                            })}
